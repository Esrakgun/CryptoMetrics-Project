...
const Header = () => {
  ...
  const currencyHandler=(e)=>{
    // Selected alanındaki Değişim Neticesinde elde edilen değeri Al:
  ...
  return (
    <header className="flex items-center justify-between px-[10%] py-5 border-b-3 border-[#3c3c3c] bg-[#1a1a40]">
      {/* Logo Kısmı: */}
      <Link to="/">
        <img 
        src="/logo.png" 
